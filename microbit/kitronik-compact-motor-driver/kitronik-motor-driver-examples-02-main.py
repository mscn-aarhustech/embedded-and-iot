...
while True:
    ...
    # Step 1: Rotate left at full speed
    display.show("1")
    motor_run(MOTOR1_PIN1, MOTOR1_PIN2, 1.0)
    motor_run(MOTOR2_PIN1, MOTOR2_PIN2, -1.0)
    ...
    # Step 2: Rotate right at half speed
    display.show("2")
    motor_run(MOTOR1_PIN1, MOTOR1_PIN2, -0.5)
